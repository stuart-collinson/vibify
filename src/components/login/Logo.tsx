  ...
  return (
    <div className="mb-12 text-center">
      <div className="relative mb-8 inline-block">
        <div className="group relative flex h-20 w-20 items-center justify-center overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-2xl shadow-emerald-500/50">
